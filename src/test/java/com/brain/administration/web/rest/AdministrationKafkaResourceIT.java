...
import com.brain.administration.config.KafkaProperties;
...
class AdministrationKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/administration-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/administration-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
